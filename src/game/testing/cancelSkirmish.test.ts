...
describe('parseAbilities — cancel a skirmish', () => {
    it('Escape : exert bearer twice → cancel involving him (prevent Ombre ignoré pour l’instant)', () => {
        const text =
    ...
    it('Gandalf’s Staff : exert named bearer twice', () => {
        const text =
...
describe('CANCEL_SKIRMISH — runtime', () => {
    it('Évasion : affaiblit Merry ×2 et annule son escarmouche (sans blessures)', () => {
